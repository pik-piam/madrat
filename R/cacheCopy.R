...
#' @param target folder to which the files should be copied. If NULL no
#' data is copied.
#' @param filter regular expression to filter the cache files shown in the 
#' log file.
#' @return A vector of cache files which match the given log information 
#' and filter
