...
test_that("Aggregation works", {
  ...
  expect_warning(a <- nc(calcOutput("AggregationTest", aggregate = "glo")),
    paste("Ignoring column\\(s\\) X, region, global from .* as the column\\(s\\) already exist in another mapping\\."))
