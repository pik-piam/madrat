test_that("puc creation works", {
   ...
   expect_true(file.exists("rev42_extra_example.puc"))
   untar("rev42_extra_example.puc")
   ...
   expect_error(pucAggregate("rev42_extra_example.puc", bla = "blub"), "cannot be changed in the given puc")
   expect_message(pucAggregate("rev42_extra_example.puc", extra = "blub", regionmapping = "regionmappingH12.csv"),
                  "Run calcOutput")
   expect_message(pucAggregate("rev42_extra_example.puc", extra = "blub", regionmapping = "regionmappingH12.csv"),
                  "already available")
