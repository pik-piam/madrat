...
fp <- madrat:::fingerprint("calcTauTotal", packages = "madrat")
```
...
```{r, echo = TRUE, eval=TRUE}
fp <- madrat:::fingerprint("calcExample", packages = "madrat")
fp2 <- madrat:::fingerprint("calcExample2", packages = "madrat")
```
...
fp2 <- madrat:::fingerprint("calcExample2", packages = "madrat")
fp3 <- madrat:::fingerprint("calcExample3", packages = "madrat")
```
