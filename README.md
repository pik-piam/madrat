...
R package **madrat**, version **1.102.9**
...
https://doi.org/10.5281/zenodo.1115490), R package version 1.102.9, <URL: https://github.com/pik-piam/madrat>.
...
@Manual{,
  ...
  year = {2021},
  note = {R package version 1.102.9},
