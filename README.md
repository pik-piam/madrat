...
R package **madrat**, version **2.8.0.9004**
...
Dietrich J, Baumstark L, Wirth S, Giannousakis A, Rodrigues R, Bodirsky B, Kreidenweis U, Klein D, Führlich P (2022). _madrat: May All Data be Reproducible and Transparent (MADRaT)_. doi: 10.5281/zenodo.1115490 (URL: https://doi.org/10.5281/zenodo.1115490), R package version 2.8.0.9004, <URL: https://github.com/pik-piam/madrat>.
...
@Manual{,
  ...
  year = {2022},
  note = {R package version 2.8.0.9004},
