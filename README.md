...
R package **madrat**, version **3.0.3.9001**
...
Dietrich J, Baumstark L, Wirth S, Giannousakis A, Rodrigues R, Bodirsky B, Kreidenweis U, Klein D, Führlich P (2023). _madrat: May All Data be Reproducible and Transparent (MADRaT)_. doi:10.5281/zenodo.1115490 <https://doi.org/10.5281/zenodo.1115490>, R package version 3.0.3.9001, <https://github.com/pik-piam/madrat>.
...
@Manual{,
  ...
  year = {2023},
  note = {R package version 3.0.3.9001},
