...
R package **madrat**, version **1.100.4**
...
Dietrich J, Baumstark L, Wirth S, Giannousakis A, Rodrigues R, Bodirsky B, Kreidenweis U, Klein D (2021). _madrat: May All
Data be Reproducible and Transparent (MADRaT)_. doi: 10.5281/zenodo.1115490 (URL: https://doi.org/10.5281/zenodo.1115490), R
package version 1.100.4, <URL: https://github.com/pik-piam/madrat>.
...
@Manual{,
  ...
  year = {2021},
  note = {R package version 1.100.4},
