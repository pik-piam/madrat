...
R package **madrat**, version **1.100.5**
...
Kreidenweis U, Klein D (2021). _madrat: May All Data be Reproducible and
Transparent (MADRaT)_. doi: 10.5281/zenodo.1115490 (URL:
https://doi.org/10.5281/zenodo.1115490), R package version 1.100.5, <URL:
...
@Manual{,
  ...
  year = {2021},
  note = {R package version 1.100.5},
